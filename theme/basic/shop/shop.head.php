...
function close_login(){
	...
	<div id="head_wrap">
		...
		<div id="head">
			<h1><a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/main/top/top_logo.png" alt="<?php echo $config['cf_title']; ?>"></a></h1>
			...
			<div id="head_dot3">
				<?
					...
					if($sso[in_id]){
						...
						$url_sso = "http://portal.mainp.kr/sso2.php?return_url=".$url_link."&in_id=".$sso[in_id];
						$sso_onclick = "";
					}else{
						$url_sso = "#";
		...
		<div id="head_menu_wrap">
			<div id="head_menu">
				<ul class="dp1">
					...
					<li class="fL dept"><a href="<?php echo G5_BBS_URL ?>/content.php?co_id=0101" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_1','','<?php echo G5_IMG_URL ?>/main/top2/menu_01ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_01.png" alt="" name="menu_1" id="menu_1" /></a></li>
