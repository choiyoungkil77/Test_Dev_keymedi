...
<? }?>
	...
	<div id="contents_nav_container">
		<ul class="default">
			<? for ($i=0; $i <= $total; $i++) {?>
			<li><img src="<?php echo G5_IMG_URL ?>/main/vs/vs_btn.jpg" width="148" height="35" alt="" /><span><?=$title[$i]?></span></li>
			<? }?>			
		</ul>
		<div class="over">
			<ul>
			<? for ($i=0; $i <= $total; $i++) {?>
				<li><img src="<?php echo G5_IMG_URL ?>/main/vs/vs_btnov.jpg" width="148" height="35"  alt="" /><span><?=$title[$i]?></span></li>
			<? }?>
			</ul>
		</div>
		<ul class="btn">
