            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="od_receipt_price" value="<?php echo $amount['receipt']; ?>" id="od_receipt_price" class="frm_input"> 원
                    </td>
                </tr>
                <tr>
				...
				<tr>
                    ...
                    <td><input type="text" name="od_coupon" value="<?php echo $od['od_coupon']; ?>" id="od_coupon" class="frm_input" size="10"> 원 </td>
                </tr>
				<tr>
                    <th scope="row"><label for="od_coupon_one">개별상품 0원처리</label></th>
                    <td><input type="checkbox" name="od_coupon_one" value="1"> 처리하기</td>
                </tr>
                <tr>
