    ...
    <tr>
        ...
        <td>
            ...
            <select name="bn_position" id="bn_position">
				...
				<option value="키메디왼쪽" <?php echo get_selected($bn['bn_position'], '키메디왼쪽'); ?>>키메디왼쪽</option>
                <option value="키메디메인" <?php echo get_selected($bn['bn_position'], '키메디메인'); ?>>키메디메인</option>
				...
				<option value="산협몰 로그인페이지" <?php echo get_selected($bn['bn_position'], '산협몰 로그인페이지'); ?>>산협몰 로그인페이지</option>

				<option value="키메디몰_상단" <?php echo get_selected($bn['bn_position'], '키메디몰_상단'); ?>>키메디몰_상단</option>
				<option value="산협몰_상단" <?php echo get_selected($bn['bn_position'], '산협몰_상단'); ?>>산협몰_상단</option>
