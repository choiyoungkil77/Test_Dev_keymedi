...
WHERE s.mb_id = m.mb_id) AS mb_11 " . $sql_common;
$row = sql_fetch($sql);
$total_count = $row['cnt'];
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>		
		...
		<th scope="col" rowspan="3">사이트구분</th>
		<? if($is_admin) { ?>
		<th scope="col" rowspan="3">PG사 주문코드</th>
		<th scope="col" rowspan="3">공급업체명</th>
		<? } ?>
		...
		<th scope="col" rowspan="3">거래명세표</th>
    </tr>
    <tr>
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
		...
		<td rowspan="3" class="td_mngsmall"><a href="item_account.php?od_id=<?php echo $row['od_id']; ?>" target="_blank" class="view_item_account">거래명세표</a></td>
    </tr>
    ...
    <tr class="<?php echo $bg; ?>">
        <td headers="th_odrstat" class="td_odrstatus">
            ...
            <strong><?php echo $row['od_status']; ?></strong>
        </td>
