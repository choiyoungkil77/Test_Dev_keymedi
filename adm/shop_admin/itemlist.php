...
<? if($is_admin) { ?>
	<a href="./itemexcel_down.php">엑셀다운로드</a>
<? } ?>
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="3"><?php echo subject_sort_link('it_id', 'sca='.$sca); ?>마스터 코드</a></th>
		<? if($is_admin) { ?>
		<th scope="col" rowspan="3">등록업체수</th>
		<? }else{ ?>
		<th scope="col" rowspan="3">등록여부</th>
		<? } ?>
