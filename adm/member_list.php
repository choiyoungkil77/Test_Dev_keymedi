...
<select name="mb_where"> 
	<option value="산부인과 협동조합" <?php echo get_selected($_GET['mb_where'], "산부인과 협동조합"); ?>>산부인과 협동조합</option>
...
<div class="tbl_head02 tbl_wrap">
	...
	<? } ?>
		...
		<th scope="col" rowspan="2" id="mb_list_id">회원구분</th>
        <th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_name') ?>이름</a></th>
		<th scope="col" id="mb_list_name">생년월일</th>

       
        <th scope="col" id="mb_list_mobile">휴대폰</th>
		<th scope="col" id="mb_list_mobile">이메일</th>
		<th scope="col" id="mb_list_mobile">학회</th>
		<th scope="col" id="mb_list_mobile">근무형태</th>
		<th scope="col" id="mb_list_mobile">가입경로</th>


        <th scope="col" id="mb_list_auth">상태/<?php echo subject_sort_link('mb_level', '', 'desc') ?>권한</a></th>
		<th scope="col" colspan="2" id="mb_list_cert"><?php echo subject_sort_link('mb_certify', '', 'desc') ?>본인확인</a></th>
        <th scope="col" id="mb_list_lastcall"><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최종접속</a></th>
        <th scope="col" rowspan="2" id="mb_list_lastcall">사업자등록</th>
...
<? } ?>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        if ($is_admin == 'group') {
            ...
            $s_mod = '<a href="./member_form.php?'.$qstr.'&amp;w=u&amp;mb_id='.$row['mb_id'].'&amp;mb_where='.$mb_where.'">수정</a>';
        }
