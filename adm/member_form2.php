...
<input type="hidden" name="mb_v" value="<?php echo $mb['mb_v'] ?>">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>       
        ...
        <td><input type="text" name="mb_15" value="<?php echo $mb['mb_15'] ?>" id="mb_15" class="frm_input required" required size="15" maxlength="20"></td>
    </tr>
