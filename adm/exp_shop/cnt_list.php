...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr> 
        ...
        <th scope="col"><?php echo subject_sort_link('it_id', 'sca='.$sca); ?>마스터코드</a></th>
		<?if($is_admin){?>
		<th scope="col" >셀러상품코드</th>
		<? } ?>
		...
		<th scope="col" >제조사</th>
		<th scope="col" >구분</th>
		<th scope="col" ><?php echo subject_sort_link('it_stock_qty', 'sca='.$sca); ?>재고총계</a></th>

		<th scope="col" ><?php echo subject_sort_link('it_stock_qty', 'sca='.$sca); ?>산부및메디몰</a></th>
		<th scope="col" ><?php echo subject_sort_link('it_stock_qty', 'sca='.$sca); ?>피부비만</a></th>
    ...
    <tr class="<?php echo $bg; ?>">  
		...
		<td style="width:100px;text-align:center;"  rowspan="2"><a href="#" onclick="chang_tmp('<?=$i?>','<?=$row[it_id]?>','<?=$rows1[it_id]?>');return false;">[수정]</a></td>
   </tr>
   </tr>
