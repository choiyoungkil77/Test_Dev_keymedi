...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td rowspan="3" class="td_mng">
			<? if($row['it_8']==""){ ?>
			<a href="./itemcopy.php?it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&site_code=<?=$site_fix?>" class="itemcopy" target="_blank"><span class="sound_only"><?php echo htmlspecialchars2(cut_str($row['it_name'],250, "")); ?> </span>상품등록</a>
			<? } ?>
			<? if($is_admin) { ?>
