...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link("it_type1", $qstr, 1); ?>베스트<br>상품</a></th>
        <!-- <th scope="col"><?php echo subject_sort_link("it_type4", $qstr, 1); ?>인기<br>상품</a></th> -->
        <th scope="col"><?php echo subject_sort_link("it_type5", $qstr, 1); ?>특가<br>상품</a></th>
        <th scope="col">관리</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall">
            <a href="./itemform.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&amp;<?php echo $qstr; ?>&amp;site_code=<?=$site_fix?>"><span class="sound_only"><?php echo cut_str(stripslashes($row['it_name']), 60, "&#133"); ?> </span>수정</a>
         </td>
    </tr>
    <?php
    }
