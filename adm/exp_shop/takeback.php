...
<select name="site_code" id="site_code">
	...
	<option value="20" <?=($site_code=="20")?"selected":""?> >산부인과 협동조합</option>
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>" style="height:45px;">
		...
		<?
			if($site_class == "20"){ echo "산부인과 협동조합";$site_fix = "shop";}else if($site_class == "99"){ echo "메디몰";$site_fix = "shop"; }else{ echo "피부비만";$site_fix = "shop_skin";}
