    ...
    <tr>
        ...
        <td>
            ...
            <select name="nw_division" id="nw_division">
                <option value="both"<?php echo get_selected($nw['nw_division'], 'both', true); ?>>생협몰과 메디몰</option>
                <option value="comm"<?php echo get_selected($nw['nw_division'], 'comm'); ?>>메디몰</option>
                <option value="shop"<?php echo get_selected($nw['nw_division'], 'shop'); ?>>생협몰</option>
