...
if($sso[out_id]){
	...
	if($ck[cnt] > 0 ){
		...
		sql_query($add_sqld);
		$add_sqld = "insert into sso2.user_sso set wr_key = 'SHOP_SKIN' , in_id = '$tmp_id' , out_id = '$member[mb_id]' ";
		sql_query($add_sqld);
