	...
	/*
		...
		*/
		...
		$("#contents_nav_container .btn li").hover(
			function(){
				clearTimer();
				$("#contents_nav_container .over").stop().animate({left:148*$(this).index()},500,"easeOutQuint");
				$("#contents_nav_container .over ul").stop().animate({left:-148*$(this).index()},500,"easeOutQuint");
			},
			function(){
				setTimer();
				$("#contents_nav_container .over").stop().animate({left:148*currentBanner},500,"easeInOutQuint");
				$("#contents_nav_container .over ul").stop().animate({left:-148*currentBanner},500,"easeInOutQuint");
			}
		);
		...
		function bannerSlide(num,sel){
			...
			if(!movement){
				...
				$("#contents_nav_container .over").stop().animate({left:148*currentBanner},500,"easeOutQuint");
				$("#contents_nav_container .over ul").stop().animate({left:-148*currentBanner},500,"easeOutQuint");
