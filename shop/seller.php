...
//echo  " select it_id {$sql_common} where " . implode(" and ", $where)." ".$sql_order . $sql_limit ;

$sql_to = sql_query(" select it_8 as it_id {$sql_common} where " . implode(" and ", $where)." group by it_8 ".$sql_order . $sql_limit ) ;
//$sql_to = sql_query(" select it_id {$sql_common} where " . implode(" and ", $where)." ".$sql_order . $sql_limit ) ;
$it_id_ar = "";
...
//echo " select it_id {$sql_common} where " . implode(" and ", $where) . implode(" and ", $where2)." group by it_8 limit ".$from_record.",". $items;
...
<div id="ssch">
    ...
    <div id="seller_frm">
     <?
		$sell = sql_fetch("select * from {$g5['member_table']} where mb_v = '4' and mb_leave_date = '' and mb_id = '$q2' "); 
		switch($sell[mb_13]){
